...
$stmt->execute([$id_client, $id_voiture, $date_debut, $date_fin, $prix_total]); // Statut par défaut : 'en_attente'
...
<body class="res_display">
    ...
    <button class="btn_res">
        <a class="lien_res" href="index.php">Retour à l'accueil</a>
    </button>
</body>
</html>
